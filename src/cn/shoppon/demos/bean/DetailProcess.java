...
import cn.shoppon.demos.model.IntentList;
...
public class DetailProcess implements Comparable<Object> {
	...
	public DetailProcess(Context ctx,
	...
	public void fetchPackageInfo() {
		if (pkginfo == null && appinfo != null)
			pkginfo = MiscUtil.getPackageInfo(pm, appinfo.packageName);
	}
	...
	public int compareTo(Object another) {
		if (another instanceof DetailProcess && another != null) {
			return this.getTitle().compareTo(
					((DetailProcess) another).getTitle());
		}
		return -1;
	}
