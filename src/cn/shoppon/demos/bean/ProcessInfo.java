package cn.shoppon.demos.bean;

import java.util.ArrayList;

import cn.shoppon.demos.utils.RunScript;
import cn.shoppon.demos.utils.StrUtil;
...
public class ProcessInfo {
	...
	public static class PsRow {
		...
		public String toString() {
			...
			retValue = "PsRow ( " + super.toString() + TAB + "pid = " + this.pid + TAB + "cmd = " + this.cmd + TAB + "ppid = " + this.ppid
					+ TAB + "user = " + this.user + TAB + "mem = " + this.mem + " )";
